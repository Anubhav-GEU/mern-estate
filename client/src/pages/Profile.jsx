...
import { updateUserStart, updateUserSuccess, updateUserFailure, deleteUserFailure, deleteUserStart, deleteUserSuccess, signOutUserStart, signInFailure, signOutUserFailure, signOutUserSuccess } from '../redux/user/userSlice';
...
export default function Profile() {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <p className='text-green-700 mt-5'>{updateSuccess ? 'User detail is updated successfully!' : ""}</p>
